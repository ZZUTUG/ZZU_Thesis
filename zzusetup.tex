...
\zzusetup{
  title              = {郑州大学学位论文模板示例文档 \zzuthesisversion},
  title*             = {An example of thesis template for \\ Zhengzhou University}, %\zzuthesisversion},
  stuID              = {202112222014346},
  author             = {王建召},
  author*            = {Yin Zhenhao},
  speciality         = {水工结构工程},
  supervisor         = {谷教授},
  ...
  signsupervisor     = {郑州大学，XXX，XXX}, % 答辩委员签名页 导师：  默认为空
  %
  %
  %
...
\bibliographystyle{zzuthesis-numerical}

% 著者-出版年制
% \usepackage{natbib}
% \bibliographystyle{zzuthesis-authoryear}

% 本科生参考文献的著录格式
% \usepackage[sort]{natbib}
% \bibliographystyle{zzuthesis-bachelor}

% 参考文献使用 BibLaTeX 宏包
% \usepackage[style=zzuthesis-numeric]{biblatex}
% \usepackage[bibstyle=zzuthesis-numeric,citestyle=zzuthesis-inline]{biblatex}
% \usepackage[style=zzuthesis-authoryear]{biblatex}
% \usepackage[style=zzuthesis-bachelor]{biblatex}
% 声明 BibLaTeX 的数据库
